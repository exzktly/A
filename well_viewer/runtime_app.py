...
class WellViewerApp(QWidget):
    ...
    def _refresh_sidebar_map_now(self) -> None:
        ...
        # group-broadcast click (see ``_on_sidebar_plate_well_activated``)
        # promotes the activated group's wells to ``_paint_lit``. Other
        # tabs in rep-mode keep the legacy "no per-well selection" override.
    ...
    def _on_sidebar_plate_well_activated(self, well_id: str) -> None:
        ...
        # the plot refocuses, and the plate's three-state painter promotes
        # those wells to the raised + bright (``_paint_lit``) look. Other
        # groups stay in the recessed-with-tint state.
