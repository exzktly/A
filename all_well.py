    ...
    def _toggle_help_drawer(self) -> None:
        ...
        if self._help_drawer is None:
            ...
            body.setText(
                ...
                "<b>Sidebar plate</b><br>"
                "• Clicking a well toggles its group's visibility on the "
                "active plot. Click a row letter or column number to toggle "
                "every group crossing it.<br>"
                "• On Sample Definitions / Review CSV the plate stays in "
                "per-well selection mode (drag to select multiple).<br><br>"
